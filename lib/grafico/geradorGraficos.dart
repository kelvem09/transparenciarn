    ...
    if (municipio == null) {
      ...
      if (ano == null && mes == null) {
        ...
        Map<double, double> valores = {
          //primeiro valor é eixo x(0 a 11) e o segundo é o eixo y (0 a 10)
          0: 1.2,
          1: 1.4,
          2: 1.3,
          3: 1.6,
        ...
        return GraficoDeBarras(
            label: "2022", bottomTitles: bottomTitles, valores: valores);
        ...
        Map<double, double> valores = {
          //primeiro valor é eixo x(0 a 11) e o segundo é o eixo y (0 a 6)
          0: 1.4,
          1: 1.6,
          2: 1.4,
          3: 1.3,
